...
//               description: `Access to ${courseName} course with lifetime access`,
//             },
//             unit_amount: coursePrice, // in smallest currency unit (e.g., paise)
//           },
//           quantity: 1,
//         },
//       ],
...
// // ------------------------
// // Verify Checkout Session & Complete Purchase
// // ------------------------
// paymentRouter.post('/verify-session', authenticate, async (req, res) => {
//   try {
//     const { sessionId } = req.body;
...
//       return res.status(400).json({
//         success: false,
//         message: 'Course ID missing in session metadata',
//       });
//     }

//     // Mock request for purchase controller
//     const purchaseReq = {
//       params: { courseId },
//       user: { userId },
//       body: { sessionId, paymentMethod: 'stripe' },
...
//     // Mock response object to capture controller result
//     let purchaseResult = null;
//     let statusCode = 200;
//     const mockRes = {
//       status: (code) => {
...
//     if (statusCode === 200 && purchaseResult?.success) {
...
//     case 'checkout.session.completed':
//       const session = event.data.object;
//       console.log('Payment successful for course:', session.metadata.courseId);
//       console.log('Session ID:', session.id);
//       console.log('Customer Email:', session.customer_details?.email);
//       break;
//     default:
