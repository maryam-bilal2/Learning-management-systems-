...
const StudentDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 pt-24 flex items-center justify-center">
      ...
      <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 pt-24 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <button
            ...
            className="px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200"
          >
            Try Again
          </button>
        </div>
        ...
        >
          {statsArray.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className={`w-12 h-12 bg-linear-to-r ${colorClasses[stat.color]} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-200`}>
                ...
                filteredCourses.map((course, index) => (
                  ...
                  >
                    {viewMode === 'grid' ? (
                      <>
                        {/* Course Thumbnail */}
                        <div className="relative h-44 lg:h-48 bg-linear-to-r from-blue-600 to-purple-600 overflow-hidden">
                        ...
                        <div className="p-6">
                          ...
                          <div className="mb-4">
                            ...
                            <div className="w-full bg-slate-700 rounded-full h-2">
                              <div 
                                className={`h-2 rounded-full bg-linear-to-r ${getProgressColor(course.progress)} transition-all duration-300`}
                          ...
                          {/* Action Button */}
                          <button 
                            className="w-full mt-4 px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-[1.02] transition-all duration-200 flex items-center justify-center space-x-2"
                            onClick={() => handleStartLearning(course.id)}
                          >
                      ...
                      <div className="flex items-center space-x-6 p-6">
                        {/* Thumbnail */}
                        <div className="w-20 h-14 lg:w-24 lg:h-16 bg-linear-to-r from-blue-600 to-purple-600 rounded-lg shrink-0 relative overflow-hidden">
                          {course.thumbnail && course.thumbnail !== '/api/placeholder/300/200' ? (
                            <img 
                              src={course.thumbnail} 
                              alt={course.title}
                        ...
                        <div className="flex flex-col items-end space-y-2 px-2">
                          ...
                          <button 
                            className="px-4 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 text-sm"
                            onClick={() => handleStartLearning(course.id)}
                          >
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center space-x-3 p-3 bg-linear-to-r from-blue-600 to-blue-700 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200">
