    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-lg text-slate-300 mb-6 leading-relaxed">
                At Skillbridge, we believe that quality education should be accessible to everyone, 
            ...
            <motion.div 
              ...
              transition={{ delay: 0.2 }}
            >
              <div className="bg-linear-to-br from-blue-600/20 to-purple-600/20 border border-blue-500/20 rounded-3xl p-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-linear-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div 
            className="bg-linear-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 rounded-3xl p-8 mb-8"
            variants={fadeInUp}
            transition={{ delay: 0.2 }}
          >
      ...
      {/* Call to Action */}
      <motion.section 
        className="py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-blue-600/10 to-purple-600/10"
        variants={fadeInUp}
        initial="initial"
        animate="animate"
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.a
              href="/course"
              className="inline-flex items-center gap-2 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
