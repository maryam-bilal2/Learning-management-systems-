export default function Companies() {
  return (
    <section className="py-20 bg-linear-to-b from-slate-950 to-[#0a1128]">
      <div className="container mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center px-4 py-2 bg-linear-to-r from-blue-600/20 to-blue-800/20 rounded-full border border-blue-500/30 mb-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="absolute inset-0 bg-linear-to-r from-blue-600/20 to-purple-600/20 rounded-3xl blur-3xl transform rotate-3"></div>
            <div className="relative">
              ...
              />
              <img
                className="w-full h-auto rounded-3xl border border-blue-900/30 shadow-2xl shadow-blue-900/20 object-cover mt-16"
          ...
          <div className="space-y-10 order-1 lg:order-2 max-w-3xl mx-auto">
            ...
            {[
              ...
              <div
                key={index}
                className={`group p-6 md:p-8 rounded-2xl bg-linear-to-br from-black/10 via-black/5 to-transparent ${feature.border} transition-all duration-300 hover:shadow-lg hover:scale-[1.02]`}
              >
                <div className="flex items-start gap-5 md:gap-6">
                  <div
                    className={`shrink-0 p-4 bg-linear-to-br ${feature.colors} rounded-xl ${feature.shadow} transition-all duration-300`}
                  >
                    <svg
                      width="32"
                      height="32"
