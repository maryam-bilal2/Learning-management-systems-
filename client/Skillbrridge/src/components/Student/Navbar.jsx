          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {isLoggedIn ? (
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  <AnimatePresence>
                    {showProfileDropdown && (
                      ...
                      >
                        {/* User Info Header */}
                        <div className="p-6 bg-linear-to-r from-blue-600/10 to-purple-600/10 border-b border-slate-700/50">
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  to="/signup"
                  className="px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"
                >
                  Get Started
                </Link>
              </div>
            ...
            >
              <div className="p-6 space-y-4">
                ...
                {isLoggedIn ? (
                  <>
                    {/* User Info */}
                    <div className="p-4 bg-linear-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-slate-700/50">
                      <div className="flex items-center space-x-3">
                        {user?.avatar ? (
                          <img 
                            src={user.avatar} 
                          ...
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${user?.role === 'educator' ? 'bg-linear-to-r from-purple-600 to-pink-600' : 'bg-linear-to-r from-blue-600 to-purple-600'}`}>
                            <User className="w-5 h-5 text-white" />
                          </div>
                        )}
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <Link
                      to="/signup"
                      onClick={() => setIsMenuOpen(false)}
                      className="py-4 px-6 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 text-center transform hover:scale-[1.02] shadow-lg"
                    >
                      Get Started
                    </Link>
                  </div>
