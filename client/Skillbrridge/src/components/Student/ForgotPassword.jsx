        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <div className="p-3 bg-linear-to-r from-green-600 to-blue-600 rounded-xl">
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3 px-4 rounded-lg font-semibold text-sm transition-all duration-200 flex items-center justify-center space-x-2 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transform hover:scale-105 text-white"
                >
            ...
            <motion.button
              ...
              className={`w-full py-3 px-4 rounded-lg font-semibold text-sm transition-all duration-200 flex items-center justify-center space-x-2 ${
                isLoading
                  ...
                  : 'bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transform hover:scale-105'
              } text-white`}
            >
              {isLoading ? (
                <>
