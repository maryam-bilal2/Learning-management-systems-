...
const Search = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 pt-24 pb-16">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            Find Your Perfect
            <span className="bg-linear-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent block mt-2">
              Learning Path
            </span>
          </h1>
        ...
        >
          <form onSubmit={handleSearch} className="relative">
            <div className="flex items-center bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-2 shadow-2xl">
              ...
              <button
                type="submit"
                className="px-8 py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"
              >
                Search
              </button>
            </div>
...
const CourseCard = ({ course, navigate }) => {
  ...
  return (
    ...
    >
      {/* Course Thumbnail */}
      <div className="relative h-48 bg-linear-to-br from-slate-700 to-slate-800">
        {course.thumbnail ? (
          <img
      ...
      <div className="p-6">
        ...
        <button 
          ...
          className="w-full py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"
        >
          View Course
        </button>
      </div>
