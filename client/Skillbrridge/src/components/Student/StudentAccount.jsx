          ...
          >
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="relative">
                <div className="w-32 h-32 bg-linear-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center">
                  {profileData.avatar ? (
                    <img 
                  ...
                  <div className="flex space-x-3 mt-4 md:mt-0">
                    {isEditing ? (
                      ...
                      <button
                        ...
                        className="px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200"
                      >
