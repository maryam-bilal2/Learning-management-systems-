...
const StudentFeedback = () => {
  ...
  return (
    <section className="py-20 bg-linear-to-b from-slate-950 to-[#0a1128] overflow-hidden">
        ...
        <div className="hidden md:block relative overflow-hidden">
          <div className="flex gap-6 animate-scrollX">
            {[...feedbacks, ...feedbacks].map((fb, index) => (
              <div
                key={index}
                className="shrink-0 w-80 p-6 rounded-xl bg-linear-to-br from-black/10 via-black/5 to-transparent border border-gray-700 hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
              >
        ...
        <div className="block md:hidden">
          <Slider {...sliderSettings}>
            {feedbacks.map((fb, index) => (
              <div
                key={index}
                className="p-6 rounded-xl bg-linear-to-br from-black/10 via-black/5 to-transparent border border-gray-700"
              >
                <div className="flex items-center gap-4 mb-4">
                  <img
                    src={fb.image}
