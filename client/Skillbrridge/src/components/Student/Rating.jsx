        ...
        <button
          ...
          className={`w-full py-2 md:py-3 px-4 rounded-lg font-medium text-sm md:text-base transition-all duration-200 ${
            isSubmitting || !rating
              ...
              : 'bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white transform hover:scale-[1.02] shadow-lg hover:shadow-blue-500/25'
          }`}
        >
          {isSubmitting ? (
