...
const Footer = () => {
  return (
    <footer className="bg-linear-to-b from-[#001f3f] to-black text-white pt-4 pb-3 relative overflow-hidden text-sm shrink-0 border-t border-[#0a1128]">
      {/* Starry background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
          ...
          <div className="flex flex-col items-center sm:items-start">
            <div className="font-bold text-lg mb-1">skill<span className="text-[#0074D9]">bridge</span></div>
        ...
        <div className="text-center text-[#94a3b8] text-xs pt-1">
          <p>© {new Date().getFullYear()} Skillbridge Education Platform</p>
        </div>
      </div>
    </footer>
  );
