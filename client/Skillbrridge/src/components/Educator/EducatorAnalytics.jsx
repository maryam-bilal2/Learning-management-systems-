      ...
      <div className="container mx-auto px-6 lg:px-8 pb-16">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button 
              disabled={loading}
              className="px-4 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                          ...
                          return (
                            <div key={index} className="flex flex-col items-center">
                              <div className="flex-1 flex items-end">
                                <div 
                                  className="w-full bg-linear-to-t from-blue-600 to-purple-600 rounded-t-sm min-h-[4px]"
                                  style={{ height: `${height}%` }}
