  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 pt-24">
      <div className="container mx-auto px-6 lg:px-8 pb-16">
            ...
            >
              {quickStats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-12 h-12 bg-linear-to-r ${colorClasses[stat.color]} rounded-xl flex items-center justify-center mb-4`}>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {courses.slice(0, 3).map((course) => (
                    <div key={course._id} className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl overflow-hidden">
                      <div className="h-32 bg-linear-to-br from-blue-600 to-purple-600 relative">
                        {course.thumbnail ? (
              ...
              >
                <div className={`${section.bgColor} ${section.borderColor} border backdrop-blur-xl rounded-3xl p-8 hover:scale-[1.02] transition-all duration-300`}>
                  <div className="flex items-start justify-between mb-6">
                    <div className={`w-16 h-16 bg-linear-to-r ${section.color} rounded-2xl flex items-center justify-center`}>
        ...
        >
          <div className="bg-linear-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/20 rounded-3xl p-8">
            ...
            <Link
              to="/educator/add-course"
              className="inline-flex items-center space-x-2 px-8 py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200"
            >
