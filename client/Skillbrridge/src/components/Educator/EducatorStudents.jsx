...
const EducatorStudents = () => {
  ...
  const InitialsAvatar = ({ name }) => {
    const initials = (name || '')
      ...
      .toUpperCase();
    return (
      <div className="w-12 h-12 rounded-full bg-linear-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm">
        {initials || '?'}
      </div>
    );
  };
      ...
      <div className="container mx-auto px-6 lg:px-8 pb-16">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="px-4 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center space-x-2">
