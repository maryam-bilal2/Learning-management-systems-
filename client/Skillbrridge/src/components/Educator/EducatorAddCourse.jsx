        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="px-6 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        {previewMode ? (
          ...
          >
            <div className="text-center mb-8">
              <div className="w-full h-64 bg-linear-to-r from-blue-600 to-purple-600 rounded-2xl mb-6 flex items-center justify-center">
                  ...
                  <div className="flex justify-between mt-8">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <button
                        onClick={() => handleSaveCourse(true)}
                        disabled={isLoading}
                        className="px-6 py-2 bg-linear-to-r from-green-600 to-blue-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-blue-700 transition-all duration-200 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <Save className="w-4 h-4" />
                        <span>{isLoading ? 'Publishing...' : 'Publish Course'}</span>
                      </button>
