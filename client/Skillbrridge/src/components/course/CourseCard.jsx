...
const CourseCard = ({ course }) => {
  ...
  return (
    ...
    >
      {/* Course Thumbnail */}
      <div className="relative h-36 bg-linear-to-r from-blue-600 to-purple-600 overflow-hidden"> 
      ...
      {/* Course Info */}
      <div className="p-4 grow flex flex-col"> {/* // reduced from p-6 and added flex properties */}
        ...
        <div className="flex items-center justify-between mt-auto pt-2">
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="px-3 py-1 bg-linear-to-r from-blue-600 to-purple-600 text-white text-xs font-medium rounded-md hover:from-blue-700 hover:to-purple-700 transition-all duration-200 opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0"
          >
            View
          </motion.button>
        </div>
