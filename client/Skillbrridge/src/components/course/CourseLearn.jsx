...
const CourseLearn = () => {
  ...
  return (
    <div ref={containerRef} className={`h-screen bg-slate-950 flex  mt-20 overflow-hidden ${isFullscreen ? 'bg-black' : ''}`}>
      {/* Mobile Backdrop */}
            ...
            {accessLoading ? (
              ...
              <div className={`w-full ${getVideoContainerClass()} max-w-6xl mx-auto px-2 md:px-0`}>
                {currentVideoData.videoUrl ? (
                  ...
                  <div className="w-full h-full bg-linear-to-br from-slate-800 to-slate-900 rounded-lg flex items-center justify-center p-4">
