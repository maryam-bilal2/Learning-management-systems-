...
const CourseDetails = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 pt-16 md:pt-24">
  ...
  if (!course) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 pt-24">
            ...
            >
              <div className="aspect-video bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-lg md:rounded-xl overflow-hidden shadow-lg relative">
                {course.thumbnail ? (
                  ...
                  <div className="w-full h-full bg-linear-to-br from-blue-600 via-purple-600 to-indigo-700 flex items-center justify-center">
                ...
                {purchaseStatus.isEnrolled && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/20">
                    <button
                      ...
                      className="w-16 h-16 md:w-20 md:h-20 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 shadow-2xl"
                    ...
                    {course.learningObjectives && course.learningObjectives.length > 0 ? (
                      course.learningObjectives.map((objective, i) => (
                        <div key={i} className="flex items-start space-x-2 md:space-x-3">
                          <Award className="w-3 h-3 md:w-4 md:h-4 text-green-400 mt-1 shrink-0" />
                      ...
                      <div key={chapter._id} className="border border-slate-600/50 rounded-lg overflow-hidden">
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            {expandedSection === i ? (
                              <ChevronUp className="w-4 h-4 md:w-5 md:h-5 text-slate-400 shrink-0" />
                            ) : (
                            ...
                            {chapter.chapterContent.map((lecture, j) => (
                              <div key={lecture._id} className="flex items-center justify-between py-1 md:py-2">
                                <div className="flex items-center space-x-2 min-w-0 flex-1">
                                  <Play className="w-3 h-3 md:w-4 md:h-4 text-slate-400 shrink-0" />
                                  <span className="text-slate-300 text-sm md:text-base truncate">{j + 1}. {lecture.title}</span>
                                </div>
                                {lecture.duration && (
                                  <span className="text-slate-400 text-xs md:text-sm shrink-0 ml-2">{lecture.duration}</span>
                                )}
                              </div>
                            ))}
                          </div>
              ...
              {activeTab === 'instructor' && (
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4">
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-r from-blue-600 to-purple-600 rounded-full shrink-0 overflow-hidden">
                ...
                <div className="p-4 md:p-6">
                    ...
                    <div className="flex items-baseline space-x-2 md:space-x-3 mb-2">
                      ...
                      {course.originalPrice && course.originalPrice > course.price && (
                        <>
                          ...
                          <span className="px-2 py-1 bg-linear-to-r from-green-500 to-green-600 text-white text-xs font-semibold rounded-full">
                  ...
                  <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                    {!isLoggedIn ? (
                      <button
                        onClick={() => navigate('/login')}
                        className="w-full py-3 md:py-4 font-semibold rounded-lg md:rounded-xl bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-blue-500/25 text-sm md:text-base"
                      >
                        Login to Enroll
                      </button>
                      ...
                      <button
                        onClick={handleExplore}
                        className="w-full py-3 md:py-4 font-semibold rounded-lg md:rounded-xl bg-linear-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-green-500/25 text-sm md:text-base"
                      >
                        <div className="flex items-center justify-center space-x-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex items-center space-x-3 text-slate-300">
                        <div className="w-5 h-5 md:w-6 md:h-6 bg-blue-600/20 rounded-full flex items-center justify-center shrink-0">
                      ...
                      <div className="flex items-center space-x-3 text-slate-300">
                        <div className="w-5 h-5 md:w-6 md:h-6 bg-green-600/20 rounded-full flex items-center justify-center shrink-0">
                      ...
                      <div className="flex items-center space-x-3 text-slate-300">
                        <div className="w-5 h-5 md:w-6 md:h-6 bg-orange-600/20 rounded-full flex items-center justify-center shrink-0">
                      ...
                      <div className="flex items-center space-x-3 text-slate-300">
                        <div className="w-5 h-5 md:w-6 md:h-6 bg-cyan-600/20 rounded-full flex items-center justify-center shrink-0">
