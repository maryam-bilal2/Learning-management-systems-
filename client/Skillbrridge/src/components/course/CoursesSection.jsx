...
const CoursesSection = () => {
  ...
  return (
    <section className="py-20 px-6 lg:px-8 bg-linear-to-b from-slate-950 to-slate-900">
      <div className="container mx-auto">
        ...
        {/* DEBUG: show fetched titles to confirm data reaches UI
        {featuredCourses && featuredCourses.length > 0 && (
          <div className="mb-6 max-w-3xl mx-auto text-center">
            <div className="inline-block px-4 py-2 bg-green-600/20 border border-green-500/30 text-green-300 rounded-lg text-sm">
              Debug: fetched titles: {featuredCourses.map(c => c.title).join(' | ')}
            </div>
          </div>
        )} */}
        ...
        >
          <button
            ...
            className="group inline-flex items-center px-8 py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-2xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-blue-500/25"
          >
