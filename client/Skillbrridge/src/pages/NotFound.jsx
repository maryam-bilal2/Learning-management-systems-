...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Gradient orbs */}
        <div className="absolute top-1/4 left-10 w-32 h-32 bg-linear-to-r from-blue-600/10 to-purple-600/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-10 w-24 h-24 bg-linear-to-r from-purple-600/10 to-pink-600/10 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        >
          <motion.h1 
            className="text-8xl md:text-9xl font-bold text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-purple-500 to-pink-500 mb-4"
            animate={{ 
          ...
          >
            <div className="h-px w-16 bg-linear-to-r from-transparent to-blue-500"></div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linear-to-r from-blue-600/5 to-purple-600/5 rounded-full animate-pulse"></div>
